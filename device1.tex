...
Angenommen \cma{1D Beugungsproblem} die $N$ Pixel sind entlang einer
...
Funktionen. Im ersten Diagramm \figref{fig:maxima-diffraction}~left
...
wie in der roten Linie in \figref{fig:maxima-diffraction}~right
dargestellt werden.
