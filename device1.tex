...
light emitting diode (LED) as the light source in our
experiments. Below we discuss optical measures that attain homogeneity
of the illumination of both displays.
...
MMA), see \figref{fig:memi-electronics} for a plan of the
interconnections.
