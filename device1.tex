...
\figref{fig:hilo-method-description}~e). \textrm{HP} ist der
...
transfer function (siehe \figref{fig:hilo-sec-Illum2}) um die
...
\figref{fig:hilo-sec-Illum2}~right). Die beste z-Aufloesung waere fuer
$\nu_x= 1 \textrm{NA}/\lambda_0$ zu erwarten, denn dort ist die
groesste z-Ausdehnung des support der 3D OTF (siehe
\figref{fig:missing-cone}), bei kleineren Ortsfrequenzen nimmt der
