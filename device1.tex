...
\label{sec:dev1}
\begin{summary}
  In the preceding chapter I showed the underlying concept of our        \cm{more specific problems}
  ...
  The pupil plane SLM was specifically developed for our project by    \cm{MMA details later}
...
\begin{figure}[!htbp]
  ...
  \caption{Schematic of the light path through our microscope. Laser
    ...
    is a polarizing beam splitter. DBS is a dichroic beam splitter.
