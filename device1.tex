...
have anti-reflection coating for wavelengths in the range from
...
SLMs as discussed on page \pageref{sec:etendue-mma}.
...
output as it would occur without the tunnel.  Drawing the outline of the
...
\end{align}
and the maximum radius can be expressed as:
\begin{align}
...
contrast and the plate causes less back reflection than a beam
splitter cube.
