...
macrophages were grown in multiwell plates and infected a pathogen of
a hitherto poorly treatable tropical disease. Usually, large vacuoles
form in the infected cells inside which the pathogens
proliferate. However, for this essay, a chemical from a compound
library is added to the culture medium which can potentially harm or
kill the pathogens. After an incubation period of a few days, the
nuclei and vacuoles in the host cells are labeled with fluorescent
...
consider phototoxicity to prevent that the cells come to harm from the
