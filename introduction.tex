...
\nomenclature{$\beta$}{Magnification of an objective
  $\beta=f_\mathrm{TL}/f$, for Zeiss lenses the magnification
  $\beta$ is written on the objective and the focal length of the tube
  lens is defined as $f_\textrm{TL}=\unit[164.5]{mm}$}
...
Sine condition. This type of lens carries out a Fourier transform,
...
objective fill out a segment of the Ewald sphere as shown in
\figref{fig:widefield-microscope}~a). Scaling this segment with
$f\lambda_0$ leads to the aplanatic surface of the lens.
