...
of my visits in Paris \citep{Aulner2013}.

FIXME translate: Fuer diese Studie wurden Zellen in multiwell plates
mit einem Erreger einer bisher schlecht heilbaren Tropenkrankheit
infiziert. Normalerweise bilden sich in infizierten Zellen grosse
Vakuolen in denen sich der Erreger vermehrt. Dem Naehrmedium in den
einzelnen wells wird jedoch jeweils ein chemical compound aus einer
library zugegeben der potentiell den Erreger abtoetet.  Nach einer
Inkubationszeit von wenigen Tagen werden die Zellkerne und Vakuolen
mit Farbstoffen markiert und Bilder jeder einzelnen Zelle und der
lebenden Erreger in einem automatischen spinning-disk Mikroskop (Opera
QEHS, PerkinElmer Technologies) aufgenommen.  Durch automatische
Bildauswertung werden die Erreger gezaehlt und damit potentiell
wirksame Heilmittel entdeckt. Die Form der Zellkerne in den Bilddaten
ermoeglicht es tote Wirtszellen zu identifizieren, so dass dieser
Essay es ermoeglicht compounds zu identifizieren, die auch die
Wirtszelle schaedigen und nicht als Medizin in Frage kommen.

Diese Technologie steckt noch in den Kinderschuhen aber sie hat das
Potential dass drug screening essays zu verbilligen, so dass auch
Tropenkrankheiten untersucht werden koennen fuer die bisher kein Markt
sichtbar war um grosse Investitionen von Pharmaunternehmen zu
rechtfertigen. Ausserdem muessen potentiell deutlich weniger Tiere
leiden, denn die Zellen eines Individuums koennen zur Untersuchung
vieler compounds eingesetzt werden.

In der beschriebenen Studie wurden die Bilder nur einmalig nach dem
Experiment erzeugt.  Noch bessere Einsichten kann man sich von
realtime monitoring und kinetic studies versprechen. In diesem Fall
muss man jedoch auch die Phototoxicitaet
beruecksichtigen. Schliesslich will man nicht dass sowohl Zellen als
auch Erreger durch das Licht zugrundegehen bevor irgendeine Wirkung
der Chemikalien sichtbar wird.

As part of our collaboration, the Institut Pasteur developed a safe
biological test system that is relatively easy to maintain
\citep{Stiernagle2006} and allows to test the phototoxicity of various
microscopes \citep{Tinevez2012}. The basis of this system are embryos
of the small invertebrate \celegans. The adult form is approximately
\unit[1]{mm} long.  Their anatomy and development are comparatively
simple and have been well characterized
