...
A focal plane detector can only measure the intensity, which has a
non-linear relationship with the field:
\begin{align}
  I'(\r')=|u'(\r')|^2=u'(\r')\cdot u'^{*}(\r').
\end{align}
Note how in the last expression, the absolute value is expressed as
the product of the amplitude $u'(\r')$ and its complex conjugate
$u'^*(\r')$. We can apply the convolution theorem and express this
product as a convolution in Fourier space, using spatial frequencies
$\vnu'$ of the image: (FIXME welches paper erklaert das als erstes?)
\begin{align}
  \widetilde I'(\vnu') &=
  \widetilde u'(\vnu') \otimes \widetilde u'^*(-\vnu') \\
  &=\left(\widetilde u(\vnu') \cdot \widetilde h(\vnu')\right) 
  \otimes
  \left(\widetilde u(\vnu') \cdot \widetilde h(\vnu')\right)^*\\
  &= \widetilde I(\vnu') \cdot 
  \left(\widetilde h(\vnu')\otimes \widetilde h^*(-\vnu')\right)
\end{align}
This expression allows a geometric interpretation.
...
Dieser Ausdruck erlaubt eine geometrische Interpretation.
