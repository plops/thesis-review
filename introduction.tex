...
We use embryos which were genetically modified. Histones are
...
on this reserve of histones. Only in a much later stage, it will form
its own histones.


The basis of the system is the embryo of a genetically
modified\footnote{Our strain has WormBase ID AZ212
  \citep{Praitis2001}.}  to include eGFP tagged histones (enhanced
green fluorescent protein, excitation maximum \unit[488]{nm}, emission
maximum \unit[509]{nm}) variant of the organism \emph{Caenorhabditis
  elegans}. These are small invertebrates. The adult form is
approximately \unit[1]{mm} long.  Their anatomy and development are
comparatively simple and have been well characterized
...
largest number of cells. The middle embryo ceased developing, and the
right embryo died even earlier and nearly all its fluorophores are
bleached at the end of the experiment.

It should be noted, that the embryos at their early stage of
development do not produce the fluorescent proteins themselves. The
egg receives a certain amount of histone-2B proteins, some of which is
genetically tagged with the green fluorescent eGFP protein, from the
parent. The histones are components of the chromatin. Therefore the
images in \figref{fig:celegans-devel} label the cell nuclei.
