...
\begin{summary}
  ...
  that allows to reduce photoxicity.  

  In this introductory chapter I describe what phototoxicity is and     \cm{phototoxicity}
  how it comes about. Then I give an example of how it influences
  biological observations in a developing \emph{C. elegans} embryo and
  describe how this particular biological system can be used to
  evaluate and compare phototoxicity of different microscopes.

  Later in this chapter I also give an an overview of image formation   \cm{cameras}
  in the wide-field microscope and describe principle limitations
  regarding its resolution and depth discrimination. Furthermore I
...
wir stellen system vor, das vorn wie ein normales mikroskop aussieht
...
\gnuplotinput{worm-integration-time}{Longer exposure times are less
  ...
  provided by J.-Y. Tinevez (Institut Pasteur, Paris) and is also
