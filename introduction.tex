...
Bei der Parameterwahl lege ich besonderen Wert auf die Noise
performance, auch wenn das mit Geschwindigkeitseinbussen einhergeht.
...
\begin{savenotes}
  \begin{table}[!htbp]
    ...
    \begin{tabular}{l r r r r r l}
      ...
      EM-CCD & 1 & 0.95 & 15.0 & $\sqrt{2}$ & 40 and 80 & E2V CCD97 \\
      EM-CCD single photon & 17 & 0.95 & 89.0 & 1 & 50 & E2V CCD97 \\
...
Bei dem mit global shutter bezeichnete Chip handelt es sich um einen
Sensor mit 5 Transistoren pro Pixel. Das erlaubt zwar aehnlich bei
einer CCD die Integration fuer jeden Pixel gleichzeitig zu starten und
zu beenden, hat aber zwei wichtige Nachteile: Die zusaetzlichen
Transistoren bedecken Platz und verringern die Quanteneffizienz des
Sensors ausserdem muss fuer quantitative Daten zu jedem Bild noch ein
Referenzframe aufgenommen werden \cite{Cameras2012}. Das vermindert
die Ausleserate und erhoeht das Ausleserauschen.

Der mit rolling shutter bezeichnete Sensor hat nur 3 Transistoren pro
Pixel (FIXME stimmt das?) und weist daher eine entsprechend hoehere
Quanteneffizienz auf. Fuer ein Signal zwischen 6 und 82 Elektronen
liefert dieser Sensor die beste Qualitaet und das bei 14 mal hoeherer
Geschwindigkeit als die EM-CCD. Fuer die Anwendung in unserem
Prototypen muss gewaehrleistet werden, dass alle Pixel integrieren,
waehrend unsere Displays Muster anzeigen. Gluecklicherweise gibt es
dafuer mittlerweile einen Modus namens global exposure
synchonization. (FIXME ronny fragen) Dabei werden die Zeilen zwar
immernoch nacheinander ausgelesen, wenn das Triggersignal
$\unit[14.6]{\mu s}$ vor der eignetlichen Belichtung erzeugt wird,
koennen alle Pixel ihre integration starten.

Der Eintrag back-thinned sCMOS ist nur ein hypothetischer Sensor den
ich eingetragen habe um zu sehen, wie die Kurve fuer einen derartigen
Sensor aussehen wuerde.
