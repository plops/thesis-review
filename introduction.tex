...
when illuminated or even genetically encoded ion channels that can be
switched by light \citep{Boyden2005}.

However, the excitation light introduces unnatural and potentially
deleterious energy into the specimen. If the observed organism is
harmed in any way by the exogenous light this effect is called
phototoxicity.
...
chapter \label{sec:illum-patterns}. These techniques have different
...
observe the liver of a live mouse.
...
accessible as in a conventional wide-field microscope.
...
I would like to portray an elegant drug screening experiment which I
have seen on one of my visits there and in which phototoxicity can
play an important role: An automatic microscope continuously images a
...
cells are each stained with a different fluorophore. The cell culture
in each well of the plates is exposed to a different
chemical.

A chemical is considered a hit and will be investigated in further
trials, when the culture cells stay healthy and the number of
pathogens decrease. As neither people nor animals come to harm, this
screening experiment is an impeccable method to systematically
understand and hopefully heal certain diseases. However, if the 
...
sie verwenden den eine genetisch modifizierte variante des
