...
Fluorescence microscopy is an old technique that has been established    % why fluorescence microscopes
...
Innovation continuously improves microscopy and occasionally new        % it continues to improve
...
Optical high resolution techniques allow to observe biological          % recently high res
processes at the scale of individual molecules (tens of nm).

Labels that report membrane potentials or viscosity within cells,       % labelling, switching
...
All these techniques have in common, that excitation light has to       % phototoxicity
...
\figref{fig:celegans-devel} compares time lapse experiments on three    % embryo example
...
temperature constant at room temperature (21\pm1 FIXEM), two different
