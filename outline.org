...
- Der Embryo entwickelt sich in den ersten Stunden innerhalb des
  ...
  reicht aus, jede Minute einen Stack mit 20 Schichten aufzunehmen, um
  das Schicksal der Zellen verfolgen zu koennen.-
...
- Ein erster Stack mit strukturierter Beleuchtung dient dazu, den
  ...
  ueber einige Zellteilungen schonend verfolgt werden. Nach einer
  Weile wird es dann vorteilhaft, angulare Beleuchtung zu nutzen um
  die Anregung von Nuklei, die Ausserhalb des Fokus liegen, zu
  vermeiden.
