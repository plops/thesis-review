...
*** The illumination system
 - Quantitative Experimente mit unserem System erfordern eine homogene
   Ausleuchtung von sowohl pupil plane als auch focal plane
   SLM. (FIXME mehr)
 ...
 - Als Beleuchtung in unseren Experimenten nutzen wir entweder einen
   ...
   state} oder eine LED. Im folgenden gehen wir darauf ein, wie wir
   die uniformitaet der Beleuchtung von beiden Displays erreichen.
 ...
 - Wenn wir einen Laser benutzen, dann senden wir den parallelen
   ...
   die Intensitaetsverteilung zu randomisieren.  (FIXME ich vermute
   mal, dass das Faserbuendel nicht mehr quadratisch auf einer seite
   ist, ist das richtig?)
 ...
 - Durch mehrfache Reflexion im Lichttunnel (quadratische 2.5mmx2.5mm
   cross section, 250mm laenge, siehe Bild 4.2) \footnote{Der Tunnel (rod
   ...
   Relais-Optik vergroessert\footnote{Ein Tunnel mit 4x4mm^2
   Querschnitt beduerfte nicht dieser Optik, wuerde jedoch unhandlich
   lange werden.} den Tunnelausgang des Tunnels auf 4x4mm^2 in die
   Ebene F'''.
 
 - Waehrend der Konzeption war auch ein Homogenisator basierend auf zwei
   Mikrolinsenarrays im Gespraech. In-Visions Planung zufolge, waere
   dieser jedoch schwieriger zu justieren als der Tunnel und zudem
   nicht fuer den vollen Wellenlaengenbereich von 400 bis 700nm
   verwendbar gewesen.
