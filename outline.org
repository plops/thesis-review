  ...
  - diaspro: nanoscopy p. 8-1
	...
	- GOT 1997 swaminathan hoang
	  - crystal structure (ormo 1996) indicates that chromophore
        ...
        - can generate reactive oxygen species (cited in bernas2004)
	  - 2000 greenbaum gfp photobleaching a model for protein damage
...
- herbert gross: handbook of optical systems physical image formation
  vol 2 page 320-352
- initiation:
  - GOT 1969 wolf 3d structure determination of semi-transparent objects
    from holographic data
  - GOT 1970 daendliker weiss reconstruction of 3d refractive index of
    scattered waves
  - NOTFOUND 1978 lohmann 3d properties of wave-fields
- final introduction:
  - NOTFOUND 1984 streibl fundamental restrictions for 3d light distributions
  - GOT 1984 streibl depth transfer by an imaging system
- became popular for microscopy
  - GOT 1985 streibl 3d imaging by a microscope
  - NOTFOUND 1986 sheppard spatial freq cutoff in 3d imaging
  - GOT 1994 gu sheppard 3d transfer functions in 4pi confocal microscopes
  - GOT 1996 kawata juskaitis differential phase constrast microscope with
    a split detector for readout system of a multilayered optical
    memory
- contestant of abbe theory for coherent illumination
  - GOT 1926 berek ueber kohaerenz und konsonanz des lichtes IV die
    optische abbildung nichtselbstleuchtender objekte
- longitudinal image
  - GOT 1966 b roy frieden longitudinal image formation
  - GOT 1967 b roy frieden optical transfer of the 3d object
- incoherent image, segment of ewald sphere as gen pupil
  - GOT 1964 mccutchen generalized aperture and 3d diffraction image
- 3d transfer function by variing incidence angles
  - NOACCESS 1986 bille schmitt beckk reconstruction of 3d light microscopic
    images comparing freq and spat domain methods
- phase anomaly in focus
  - NOTFOUND (i think it's a book) 1986 stamnes waves in focal regions
...
*** the confocal microscope
   ...
   - the thing, that daniel worked on in his first year is just the
     siedentopf illumination principle
...
** image detectors
  ...
  - 1993 eric fossum cmos sensor
  - nuvucameras.com

  - emccd gain stochastic reduces quantum efficiency
  - active pixel sensor
