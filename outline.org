...
** optical components
 ...
 - fig:memi-real zeigt schematisch den entsprechend angepassten
   ...
   System. Die Optik ist farbkorrigiert fuer Wellenlaengen im Bereich
...
*** The illumination system
 - Wenn wir einen Laser benutzen, dann senden wir den parallelen
   Strahl zunaechst in ein Buendel statistisch verteilter
   Fasern. Dieses wandelt das runde Strahlprofil in ein rechteckiges
   und randomisiert die Intensitaetsverteilung.
   
   Ein rotierendes Mikrolinsenarray mischt das Licht, so dass waehrend
   einer Belichtungszeit der Kamera moeglichst viele Modenprofile das
   Spezimen beleuchten.  Durch diese Vorgehensweise koennen wir das
   Laserlicht, das generell hohe oertliche Kohaerenz---also eine
   geringe Etendue---aufweist, an die Etendue der nachfolgenden Optik
   anpassen. 
