...
** motivation
  ...
  - c) zeigt eine sample konfiguration, bei der angular control
    ...
    - mit dem focal plane slm sind wir in der lage, den in focus
      bereich in kleinere bereiche zu teilen und nacheinander mit
...
b** initial step: sectioning through structured illumination
...
** optimization using raytracer
   - erklaere warum raytracing (statt wellenoptik) als modell reicht
