...
*** Gewaehrleistung einer homogenen Ausleuchtung
 ...
 - Durch mehrfache Reflexion im Lichttunnel (hollow
   ...
   /Laser homogenisieren/ 250mm laenge, siehe Bild 4.2) \footnote{Der
   ...
   Apertur zu aendern (FIXME ref dlpa022.pdf).  Eine Relais-Optik
   vergroessert\footnote{Ein Tunnel mit 4x4mm^2 Querschnitt beduerfte
   nicht dieser Optik, dann waeren die Winkel der Strahlen im System
   jedoch noch kleiner und der Tunnel muesste unhandlich lange
   werden.} den Tunnelausgang des Tunnels auf 4x4mm^2 in die Ebene
   F'''.
 ...
 - Zu den zwei Relais-Systemen hat der Optikdesigner kommentiert
   ...
   optimiert wurden. Beim System am Tunneleingang werden drei Elemente
   ...
   transportieren. Am anderen Ende transportieren fuenf Elemente das
...
*** Fourier-optischer Filter zur Kontrasterzeugung am pupil plane SLM
 ...
 - schlierenoptik 
   - zwei aufgaben:
     ...
     - abildung von mma nach unendlich
