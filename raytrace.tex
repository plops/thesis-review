...
focal length, the principal planes are a property of lenses that are
only defined in the paraxial limit. There are always two principal
...
plane but is deformed into a spherical surface. In section
...
This is perfectly adequate for our application. One might think it
...
depicted in \figref{fig:touch-cone}~E)). Already with six rays per
...
I described algorithms that can account for aberration that occurs
