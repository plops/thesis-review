...
FIXME TRANSLATE: Bemerkung: Nur die eingerahmten Formeln finden sich
im Quellcode fuer das Computerprogramm wieder.
\begin{figure}
  \centering
...
\begin{align}
  ...
  \end{cases}}
\end{align}
If the discriminant $d$ is negative the ray misses the sphere and
